...
int dirPin   = 4;                  // Stepstick DIR pin to Arduino digital  pin 6

int numSteps = 200;                 //720/5.625 degree = 128/2 = 64 //int numSteps = 48;Number of steps in 360 degree rotation
